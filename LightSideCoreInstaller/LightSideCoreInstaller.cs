...
public class LightSideCoreInstaller : OdinEditorWindow
{
    [ToggleLeft]
    ...
    {
        var window = GetWindow<LightSideCoreInstaller>();
        window.titleContent = new GUIContent("Light Side Core Installer");
        window.Show();
    }
