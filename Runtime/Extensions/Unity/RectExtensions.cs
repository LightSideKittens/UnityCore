...
namespace LSCore.Extensions.Unity
{
    ...
    public static class RectExtensions
    {
        ...
        {
            float width1 = Math.Min(rect.width, width);
        ...
        {
            float height1 = Math.Min(rect.height, height);
        ...
        {
            float num = rect.width / count;
            rect.width = num;
            rect.x += num * index;
            return rect;
        }
        
        public static Rect[] Split(this Rect rect, int count)
        {
        ...
        public static Rect AddPosition(this Rect rect, in Vector2 move)
        {
            rect.position += move;
            return rect;
        }
