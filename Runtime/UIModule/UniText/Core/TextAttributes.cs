...
/// </summary>
public abstract class TextAttributeBase
{
...
/// Цвет текста
/// </summary>
public sealed class ColorAttribute : TextAttributeBase
{
...
/// Прозрачность
/// </summary>
public sealed class AlphaAttribute : TextAttributeBase
{
...
/// Подчёркивание
/// </summary>
public sealed class UnderlineAttribute : TextAttributeBase
{
    public Color32? Color { get; }
...
/// Зачёркивание
/// </summary>
public sealed class StrikethroughAttribute : TextAttributeBase
{
    public Color32? Color { get; }
...
/// Выделение (маркер)
/// </summary>
public sealed class MarkAttribute : TextAttributeBase
{
    public Color32 Color { get; }
...
/// Размер шрифта
/// </summary>
public sealed class SizeAttribute : TextAttributeBase
{
...
/// Шрифт
/// </summary>
public sealed class FontAttribute : TextAttributeBase
{
...
/// </summary>
public sealed class FontStyleAttribute : TextAttributeBase
{
...
/// </summary>
public sealed class CharacterSpacingAttribute : TextAttributeBase
{
...
/// </summary>
public sealed class AlignmentAttribute : TextAttributeBase
{
...
/// </summary>
public sealed class LineSpacingAttribute : TextAttributeBase
{
    public float Spacing { get; }
...
/// Отступ
/// </summary>
public sealed class IndentAttribute : TextAttributeBase
{
...
/// Запрет переноса
/// </summary>
public sealed class NoBreakAttribute : TextAttributeBase
{
...
/// Ссылка
/// </summary>
public sealed class LinkAttribute : TextAttributeBase
{
...
/// Верхний индекс
/// </summary>
public sealed class SuperscriptAttribute : TextAttributeBase
{
...
/// Нижний индекс
/// </summary>
public sealed class SubscriptAttribute : TextAttributeBase
{
