namespace LSCore.Editor
{
    public static partial class Defines
    {
        ...
        {
            public const string ADMOB = nameof(ADMOB);
            public const string CAS = nameof(CAS);
            
            public const string RELEASE_ADS = nameof(RELEASE_ADS);
            ...
            public const string FIREBASE_AUTH = nameof(FIREBASE_AUTH);
        }
    }
}