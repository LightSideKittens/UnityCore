...
#pragma warning disable
    ...
    public static class RectExtensions
    {
        ...
        /// <summary>
        /// Determines if an <see cref="Rect"/> is a placeholder; usually (0, 0, 1, 1) in Layout.
        /// </summary>
        /// <param name="rect">The original <see cref="Rect"/>.</param>
        /// <returns><c>true</c> if the <see cref="Rect"/> is equal to (0, 0, 0, 0) or (0, 0, 1, 1); otherwise <c>false</c>.</returns>
