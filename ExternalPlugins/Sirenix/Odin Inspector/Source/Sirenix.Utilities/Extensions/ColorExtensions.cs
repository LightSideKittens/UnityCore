...
#pragma warning disable
    ...
    public static class ColorExtensions
    {
        ...
        /// <summary>
        /// Gets the perceived luminosity of a given <see cref="Color"/>.
        /// </summary>
        /// <param name="color">The current <see cref="Color"/>.</param>
        /// <param name="includeAlpha">Determines if the <see cref="Color.a">Color.a</see> value should impact the result.</param>
        /// <returns>The <see cref="float">float</see> value representing the luminosity.</returns>
        public static float PerceivedLuminosity(this Color color, bool includeAlpha = true)
        {
            if (includeAlpha && color.a <= 0.0f)
            {
                return 0f;
            }
