...
#pragma warning disable
    ...
    public static class SirenixAssetPaths
    {
        ...
        static SirenixAssetPaths()
        {
            ...
            string companyName = ReplaceIllegalCharacters(UnityEditor.PlayerSettings.companyName, '_');
            string productName = ReplaceIllegalCharacters(UnityEditor.PlayerSettings.productName, '_');
