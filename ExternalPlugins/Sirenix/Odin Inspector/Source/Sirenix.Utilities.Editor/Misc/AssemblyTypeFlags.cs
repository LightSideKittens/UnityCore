...
#pragma warning disable
    ...
    [Flags]
	[Obsolete("AssemblyTypeFlags have been made obsolete, because they cannot be determined accurately for all assemblies. Use " + nameof(AssemblyUtilities) + "." + nameof(AssemblyUtilities.GetAssemblyCategory) + "(assembly) instead.", Consts.IsSirenixInternal)]
