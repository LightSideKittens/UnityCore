...
#pragma warning disable
    ...
    {
        /// <summary>
        /// Returns <c>true</c> when the users mouse is hovering over the specified <see cref="Rect"/>
        /// </summary>
        /// <param name="current">The  <see cref="UnityEngine.Event"/>.</param>
        /// <param name="rect">The <see cref="Rect"/> to check.</param>
        /// <returns><c>true</c> if the mouse is over the specified <see cref="Rect"/> otherwise <c>false</c>.</returns>
        public static bool IsMouseOver(this Event current, Rect rect) => rect.Contains(current.mousePosition);
