...
#pragma warning disable
    ...
    public class HorizontalGroupAttribute : PropertyGroupAttribute
    {
        ...
        /// </summary>
        public float Gap = DefaultHorizontalGroupGap;
        ...
        {
            if (other is HorizontalGroupAttribute hGroup)
            {
                this.Title = this.Title ?? hGroup.Title;
                this.DisableAutomaticLabelWidth = this.DisableAutomaticLabelWidth || hGroup.DisableAutomaticLabelWidth;

                if (this.LabelWidth == 0 && hGroup.LabelWidth != 0)
                    this.LabelWidth = hGroup.LabelWidth;

                if (hGroup.Gap != DefaultHorizontalGroupGap)
                    this.Gap = hGroup.Gap;
            }
        }
    }
