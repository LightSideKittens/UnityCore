...
#pragma warning disable
    ...
    internal static class InternalAttributeExampleInfoMap
    {
        public static readonly Dictionary<Type, AttributeExampleInfo[]> Map = new Dictionary<Type, AttributeExampleInfo[]>()
        {
            ...
            {
                typeof(Sirenix.OdinInspector.PolymorphicDrawerSettingsAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.RequiredListLengthAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.TypeDrawerSettingsAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.TypeRegistryItemAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.TypeSelectorSettingsAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.UnitAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
