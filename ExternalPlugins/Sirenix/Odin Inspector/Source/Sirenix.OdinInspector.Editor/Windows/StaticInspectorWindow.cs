...
#pragma warning disable
    ...
    public class StaticInspectorWindow : OdinEditorWindow
    {
        ...
        [SerializeField, HideInInspector] private AssemblyCategory targetTypeFlags;
        ...
        public static StaticInspectorWindow InspectType(Type type, AccessModifierFlags? accessModifies = null, MemberTypeFlags? memberTypeFlags = null)
        {
            ...
            window.targetTypeFlags = (AssemblyCategory)EditorPrefs.GetInt(TargetTypeAssemblyCategoriesPrefKey, (int)(AssemblyCategory.ProjectSpecific | AssemblyCategory.UnityEngine));
        ...
        private OdinSelector<Type> SelectType(Rect arg)
        {
            ...
            var p = TypeSelectorHandler_WILL_BE_DEPRECATED.InstantiateSelector(this.targetTypeFlags,
                                                                               showNoneItem: false,
                                                                               showCategories: true);
        ...
        private void DrawFirstToolbar()
        {
            ...
            {
                TypeSelectorV2.DrawSelectorDropdown(rect1, new GUIContent(typeName), SelectType, btnStyle);
            }

            EditorGUI.BeginChangeCheck();
            this.targetTypeFlags = EnumSelector<AssemblyCategory>.DrawEnumField(rect2, null, new GUIContent("Type Filter"), this.targetTypeFlags, btnStyle);
            if (EditorGUI.EndChangeCheck())
            {
                EditorPrefs.SetInt(TargetTypeAssemblyCategoriesPrefKey, (int)this.targetTypeFlags);
            }
