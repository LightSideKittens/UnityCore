...
#pragma warning disable
    ...
    public sealed class PropertyValueEntryAlias<TActualValue, TValue> : PropertyValueEntryAlias, IPropertyValueEntry<TValue>, IValueEntryActualValueSetter<TValue> //where TValue : TActualValue
    {
        ...
        /// The most precise known contained type of the value entry. If polymorphism is in effect, this will be some type derived from <see cref="BaseValueType" />.
        /// </summary>
        public override Type TypeOfValue { get { return this.entry.TypeOfValue; } }
        ...
        /// The generic value type of the value entry alias itself, IE, the PropertyValueEntryAlias implements the IPropertyValueEntry&lt;TValue&gt; interface - this member returns TValue regardless of the actual type of the backing objects. This is a performance shortcut to checking TValue using reflection, used internally by the property system to determine whether a value entry alias needs to be swapped out with an alias for a different type.
        /// </summary>
        public override Type TValueGenericTypeArgument { get { return typeof(TValue); } }
        ...
        public bool ValueIsPrefabDifferent(TValue value, int index)
        {
            ...
            {
                return this.entry.ValueIsPrefabDifferent(default, index);
            }
