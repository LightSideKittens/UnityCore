...
#pragma warning disable
    ...
    public class TableListAttributeDrawer : OdinAttributeDrawer<TableListAttribute>, IDisposable
    {
        ...
        //private HybridObjectPicker picker;
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            //this.picker = HybridObjectPicker.Get(this,
            //                                     this.resolver.ElementType,
            //                                     this.Property.GetAttribute<TypeSelectorDrawerSettingsAttribute>(),
            //                                     this.Property.GetAttribute<PolymorphicFieldSettingsAttribute>(),
            //                                     this.Property);
            ...
            var rect = SirenixEditorGUI.BeginIndentedVertical(SirenixGUIStyles.PropertyMargin);
            {
        ...
        private void DrawToolbar(GUIContent label)
        {
            ...
            if (!this.isReadOnly)
            {
                ...
                SdfIcons.DrawIcon(btnRect.AlignCenter(13), SdfIconType.Plus);
            }
            ...
            if (!this.isReadOnly)
            {
                ...
                SdfIcons.DrawIcon(btnRect.AlignCenter(13), SdfIconType.ListOl);
            }
            ...
            if (this.filter.IsUsed) 
            {
                ...
                Rect filterRect = labelRect.TakeFromRight(labelRect.width - labelSize.x - 20);

                filterRect.width -= 10;

                this.filter.Draw(filterRect);
            }
        ...
        private void DrawCell(Column col, int rowIndex)
        {
            ...
            {
                Rect rect = GUILayoutUtility.GetRect(20, 20).AlignCenter(13, 13);
            ...
            {
                InspectorProperty cell = this.filter[rowIndex].Children[col.Name];
