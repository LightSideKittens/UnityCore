        ...
        private void DrawDropdown()
        {
            ...
            if (this.Attribute.AppendNextDrawer && !this.isList)
            {
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (this.Property.Info.TypeOfValue == typeof(Type))
                        t.image = GUIHelper.GetAssetThumbnail(null, this.Property.ValueEntry.WeakSmartValue as Type, false);

                    newResult = GenericSelector<object>.DrawSelectorDropdown(this.label, t, this.ShowSelector, !this.Attribute.OnlyChangeValueOnConfirm, GUIStyle.none, GUILayoutOptions.Width(width));
            ...
            else
            {
                ...
                if (this.Property.Info.TypeOfValue == typeof(Type))
                    valueName.image = GUIHelper.GetAssetThumbnail(null, this.Property.ValueEntry.WeakSmartValue as Type, false);
                ...
                if (this.Attribute.HideChildProperties == false && this.Property.Children.Count > 0)
                {
                    ...
                    newResult = GenericSelector<object>.DrawSelectorDropdown(valRect, valueName, this.ShowSelector, !this.Attribute.OnlyChangeValueOnConfirm);
                ...
                {
                    newResult = GenericSelector<object>.DrawSelectorDropdown(this.label, valueName, this.ShowSelector, !this.Attribute.OnlyChangeValueOnConfirm);
                }
            }
