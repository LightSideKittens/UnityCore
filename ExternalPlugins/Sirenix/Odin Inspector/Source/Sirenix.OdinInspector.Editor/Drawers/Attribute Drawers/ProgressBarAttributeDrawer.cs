...
#pragma warning disable
    ...
    public abstract class BaseProgressBarAttributeDrawer<T> : OdinAttributeDrawer<ProgressBarAttribute, T>
    {
        ...
        protected override void Initialize()
        {
            ...
            this.foregroundColorResolver = ValueResolver.Get(this.Property, this.Attribute.ColorGetter, this.Attribute.Color);
            this.backgroundColorResolver = ValueResolver.Get(this.Property, this.Attribute.BackgroundColorGetter, ProgressBarConfig.Default.BackgroundColor);
