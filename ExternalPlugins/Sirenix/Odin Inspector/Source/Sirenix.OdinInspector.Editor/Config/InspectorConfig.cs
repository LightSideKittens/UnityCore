...
#pragma warning disable
    ...
    public class InspectorConfig : GlobalConfig<InspectorConfig>, ISerializationCallbackReceiver
    {
        ...
        [Space(5)]
        [SerializeField, HorizontalGroup, OnValueChanged("UpdateAndRefreshInspector")]
        ...
        public bool EnableOdinInInspector
        {
            ...
            set
            {
                if (value != this.enableOdinInInspector)
                {
                    ...
                    this.UpdateAndRefreshInspector();
                }
            }
        }
        ...
        [Button("Update Editors", buttonSize: 22, DisplayParameters = false), HorizontalGroup(width: 100)]
