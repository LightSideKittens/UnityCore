...
#pragma warning disable
    ...
    public class GenericSelector<T> : OdinSelector<T>
    {
        ...
        private bool hasAnyItemWithIcon = false;
        ...
        protected override void DrawSelectionTree()
        {
            if (this.CheckboxToggle)
            {
                ...
                foreach (OdinMenuItem item in this.SelectionTree.EnumerateTree())
                {
                    bool hasIcon = item.IconGetter() || item.SdfIcon != SdfIconType.None;

                    this.hasAnyItemWithIcon = this.hasAnyItemWithIcon || hasIcon;
                }
            }
