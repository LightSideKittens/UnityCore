...
#pragma warning restore MA0016 // Prefer using collection abstraction instead of implementation
            ...
            public static implicit operator ReplyKeyboardMarkup?(KeyboardButton[]? buttons) => buttons is null ? default : new(
                new List<IEnumerable<KeyboardButton>> { buttons }.AsReadOnly());
            ...
            public ReplyKeyboardMarkup AddButton(KeyboardButton button)
            {
                ...
                if (keyboard.Count == 0) keyboard.Add(new List<KeyboardButton> { });
...
#pragma warning restore MA0016 // Prefer using collection abstraction instead of implementation
            ...
            public InlineKeyboardMarkup AddButton(InlineKeyboardButton button)
            {
                ...
                if (keyboard.Count == 0) keyboard.Add(new List<InlineKeyboardButton> { });
                keyboard[^1].Add(button);
                return this;
            }
