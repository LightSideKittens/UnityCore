...
namespace Telegram.Bot.Types.ReplyMarkups
{
    ...
    public abstract class ReplyMarkup
    {
        ...
        public static implicit operator ReplyMarkup?(KeyboardButton[]? buttons) => buttons is null ? default : new ReplyKeyboardMarkup(
            new List<IEnumerable<KeyboardButton>> { buttons }.AsReadOnly()) { ResizeKeyboard = true };
