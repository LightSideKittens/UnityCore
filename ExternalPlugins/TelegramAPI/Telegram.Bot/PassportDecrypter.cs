...
namespace Telegram.Bot.Passport
{
    ...
    {
        /// <summary>Represents a fatal error in decryption of Telegram Passport Data</summary>
        public PassportDataDecryptionException(string message) : base(message)
        {
        }
    }
    ...
    public class Decrypter
    {
        ...
        public Credentials? DecryptCredentials(EncryptedCredentials encryptedCredentials, RSA key)
        {
            ...
            byte[] data = System.Convert.FromBase64String(encryptedCredentials.Data);
            ...
            byte[] encryptedSecret = System.Convert.FromBase64String(encryptedCredentials.Secret);

            byte[] hash = System.Convert.FromBase64String(encryptedCredentials.Hash);
            ...
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Credentials>(json, JsonBotAPI.Settings);
        }
        ...
        public TValue? DecryptData<TValue>(string encryptedData, DataCredentials dataCredentials) where TValue : class, IDecryptedValue
        {
            ...
            byte[] dataSecret = System.Convert.FromBase64String(dataCredentials.Secret);

            byte[] dataHash = System.Convert.FromBase64String(dataCredentials.DataHash);
            ...
            string json = Encoding.UTF8.GetString(decryptedData);
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TValue>(json, JsonBotAPI.Settings);
        }
        ...
        )
        {
            ...
            byte[] dataSecret = System.Convert.FromBase64String(fileCredentials.Secret);
            byte[] dataHash = System.Convert.FromBase64String(fileCredentials.FileHash);
            if (dataHash.Length != 32) throw new PassportDataDecryptionException($"Hash length is not 32: {dataHash.Length}.");
