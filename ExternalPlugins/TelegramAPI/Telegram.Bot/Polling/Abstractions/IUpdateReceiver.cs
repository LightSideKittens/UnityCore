...
{
    /// <summary>Requests new <see cref="Update"/>s and processes them using provided <see cref="IUpdateHandler"/> instance</summary>
    [PublicAPI]
    public interface IUpdateReceiver
    {
        /// <summary>Starts receiving <see cref="Update"/>s invoking <see cref="IUpdateHandler.HandleUpdateAsync"/> for each <see cref="Update"/>.<para>This method will block if awaited.</para></summary>
