...
#pragma warning restore CS1591
            ...
            CancellationToken cancellationToken = default) where T : class
        {
            ...
            deserializedObject = await httpResponse.Content.ReadFromJsonAsync<T>(JsonBotAPI.Options, cancellationToken).ConfigureAwait(false);
                ...
                deserializedObject = await Task.Run(() => Newtonsoft.Json.JsonConvert.DeserializeObject<T>(jsonString, JsonBotAPI.Settings), cancellationToken).ConfigureAwait(false);
#endif
            }
            catch (Exception exception)
            {
        ...
        public static FileIdType GetFileIdType(string fileId) => (FileIdType)System.Convert.FromBase64String(fileId[0..4])[0];
