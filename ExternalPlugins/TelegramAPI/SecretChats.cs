...
namespace WTelegram
{
	...
	internal sealed partial class SecretChat : IObject, ISecretChat
	{
		...
		internal SortedList<int, TL.Layer23.DecryptedMessageLayer> pendingMsgs = new SortedList<int, DecryptedMessageLayer>();
	...
	public sealed class SecretChats : IDisposable
	{
		...
		public List<ISecretChat> Chats => new (chats.Values);
