...
namespace TL
{
	...
	public sealed class TLDefAttribute : Attribute
	{
		public readonly uint CtorNb;
		public bool inheritBefore;

		public TLDefAttribute(uint ctorNb)
		{
			CtorNb = ctorNb;
		}
	}
	...
	public sealed class IfFlagAttribute : Attribute
	{
		public readonly int Bit;

		public IfFlagAttribute(int bit)
		{
			Bit = bit;
		}
	}
	...
	public sealed class RpcException : WTelegram.WTException
	{
		public readonly int Code;
		/// <summary>The value of X in the message, -1 if no variable X was found</summary>
		public readonly int X;

		public RpcException(int code, string message, int x = -1) : base(message)
		{
			Code = code;
			X = x;
		}
		...
		public override string ToString()
		{
			...
			return str.Insert(str.IndexOf(':') + 1, " " + Code);
		}
	}
	...
	public sealed partial class _Message : IObject
	{
		public long msg_id;
		public int seq_no;
		public int bytes;
		...
		public _Message(long msgId, int seqNo, IObject obj)
		{
			msg_id = msgId;
			seq_no = seqNo;
			body = obj;
